class MobTypes {
    list = {
        rat: {attack: 1, max: 2,  steps: 0, },
        snake: {attack: 3,  max: 5,  steps: 25},
        rat_king: {attack: 5,  max: 10,  steps: 50},        
        spider: {attack: 10,  max: 20,  steps: 75},
        snake_queen: {attack: 15,  max: 40,  steps: 100},
